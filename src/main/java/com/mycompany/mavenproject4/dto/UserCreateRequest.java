...
public class UserCreateRequest {
    ...
    public UserCreateRequest(String username, String nombre, String apellido, String email, String password, String perfilAcademico, byte[] foto, String mimeType, String RoleName) {
